...
class TikTokApi:
    ...
    def __init__(self, **kwargs):
        ...
        logging.basicConfig(level=kwargs.get("logging_level", logging.DEBUG))
        ...
        try:
            ...
            logging.info("initialize tiktokapi success")
    ...
    def get_instance(**kwargs):
        ...
        * **kwargs
        ...
        if not TikTokApi.__instance:
            print("start initialize tiktok api")
            TikTokApi(**kwargs)
        
        logging.info("get tiktok api instance")
    ...
    def by_hashtag(self, hashtag, count=30, offset=0, **kwargs) -> dict:
        ...
        * count: The number of posts to return
        ...
        while len(response) < required_count:
            logging.info("get posts offset:" + str(offset))
            if count > maxCount:
                count = maxCount
            query = {
                "count": count,
